...
let guestArr: string[] =["Rahim", "Irha", "Reeham", "Murtasim"];
let canotAttend: string = "Reeham";
let newGuest: string = "Meerab";
...
let guestBegin: string = "Dua";
guestArr.unshift(guestBegin);
console.log(guestArr);

//Add guest middle of Array

let middleGuest: string = "Zara";
