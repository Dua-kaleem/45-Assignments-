...
const current_Users = ["Dua", "Rahima", "Salwa", " maria", "Reema"];
//list of new usernames
const new_Users = ["saniya", "RAHIMA", "salwa", " Farjah", "Zuni"];
const currUsers_lowerCase = current_Users.map((user => user.toLowerCase()));
